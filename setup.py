...
setup(
    ...
    package_data={
        "celloracle": [
            "go_analysis/data/*.txt",
            "go_analysis/data/*.obo",
            "data_conversion/*.R",
    ...
    packages=[
        ...
        "celloracle.network",
        "celloracle.trajectory",
        "celloracle.data",
        "celloracle.go_analysis",
        "celloracle.oracle_utility",
        "celloracle.motif_analysis",
        "celloracle.network_analysis",
        "celloracle.utility",
        "celloracle.applications",
        "celloracle.visualizations",
    ],
    entry_points={
        "console_scripts": [
            "seuratToAnndata = celloracle.data_conversion.process_seurat_object:main"
        ]
    },
)
